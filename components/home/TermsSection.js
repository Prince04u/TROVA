...
export default function TermsSection() {
  ...
  const handleAddToDesktop = () => {
    pushToast({
      ...
      message: "To add TROVA to your desktop, click the Share button in your browser and select 'Add to Home Screen'.",
      variant: "success",
    });
  };
  ...
  return (
    <section className="terms-premium-section-flat">
      ...
      {/* Lobby Description Text customized for TROVA */}
      <div className="terms-flat-content">
        <ul className="terms-flat-list-v2">
          ...
          <li>
            <ChevronRight className="w-4 h-4 text-gold mt-1 shrink-0" />
            <span>TROVA works with more than 10,000 online live game dealers and slot games, all of which are verified fair games.</span>
          </li>
          <li>
            <ChevronRight className="w-4 h-4 text-gold mt-1 shrink-0" />
            <span>TROVA supports fast deposit and withdrawal, and looks forward to your visit.</span>
          </li>
        </ul>

        <div className="terms-flat-warning-text-v2">
          <p className="warning-addiction">Gambling can be addictive, please play rationally.</p>
          <p className="warning-age-limit">TROVA only accepts customers above the age of 18.</p>
        </div>
